import { visionImageDataUrl, type VisionImageOptions } from "@/lib/render-images";
...
export async function storageImageDataUrl(
  ...
  // How the floor plan differs: a higher edge, a higher quality, and the
  // confirmed room cut out of the sheet. See `visionImageDataUrl`.
