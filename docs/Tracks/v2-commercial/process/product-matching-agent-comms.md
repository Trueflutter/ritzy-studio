...
## Current PR
PR #153: https://github.com/Trueflutter/ritzy-studio/pull/153

Branch: `codex/product-match-qa-warning-reporting`

## Current stage
DUAL_TRACK:
- `CONTROLLED_PREVIEW_EXPANSION_BLOCKED_WAITING_FOR_SAM_CHIEF_DECISION`
- `QA_HARNESS_ONLY_WARNING_REPORT_IMPROVEMENT_IN_PROGRESS`
...
QA-harness-only warning report improvement is now in progress in PR #153. The change preserves Product Matching selection behavior, scoring, stop rules, runtime defaults, app actions, write boundaries, and allowlists.
